...
export class DeviceService {
  ...
  private listDevicesURL = 'https://localhost:8443/listDevices';
  private updateDeviceURL = 'https://localhost:8443/updateDevice';
  private deleteDeviceURL = 'https://localhost:8443/deleteDevice';
  private createDeviceURL = 'https://localhost:8443/createDevice';
  ...
  updateCurrent(device: Device, new_value: number, controlUnit: ControlUnit): void {
    ...
    request.open("POST", "https://localhost:8443/updateCurrent", true);
